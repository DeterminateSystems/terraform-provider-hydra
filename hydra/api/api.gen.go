...
type Build struct {
	// Buildmetrics user defined build metrics from `$out/nix-support/hydra-metrics`. The file should
	...
	Buildmetrics *struct {
		// Name name of the measured build metric
		Name *string `json:"name,omitempty"`

		// Unit unit of the measured build metric
		Unit *string `json:"unit,omitempty"`

		// Value measured value
		Value *string `json:"value,omitempty"`
	} `json:"buildmetrics,omitempty"`
	Buildoutputs  *map[string]BuildOutput  `json:"buildoutputs,omitempty"`
	Buildproducts *map[string]BuildProduct `json:"buildproducts,omitempty"`

	// Buildstatus Indicates the build status:</br>
	// <ul>
	//  <li>0 : succeeded</li>
	//  <li>1 : failed</li>
	...
	// Drvpath filename of the drv
	Drvpath *string `json:"drvpath,omitempty"`

	// Finished true when the build is finished
	Finished *bool `json:"finished,omitempty"`
	Id       *int  `json:"id,omitempty"`

	// Job nix attribute from the nixexprpath
	Job *string `json:"job,omitempty"`

	// Jobset jobset this build belongs to
	Jobset *string `json:"jobset,omitempty"`

	// Jobsetevals list of evaluations this build is part of
	Jobsetevals *[]int `json:"jobsetevals,omitempty"`

	// Nixname name from the build's derivation
	Nixname *string `json:"nixname,omitempty"`

	// Priority determines the priority with which this build will be executed (higher value means higher priority)
	Priority *int `json:"priority,omitempty"`

	// Project project this build belongs to
	Project *string `json:"project,omitempty"`

	// Starttime time when build started
	Starttime *int `json:"starttime,omitempty"`

	// Stoptime time when build ended
	Stoptime *int `json:"stoptime,omitempty"`

	// System system this build was done for
	System *string `json:"system,omitempty"`

	// Timestamp time when the build was first created
	Timestamp *int `json:"timestamp,omitempty"`
}

// BuildOutput defines model for BuildOutput.
type BuildOutput struct {
	// Path The nix store path
	Path *string `json:"path,omitempty"`
}

// BuildProduct defines model for BuildProduct.
type BuildProduct struct {
	// Defaultpath if path is a directory, the default file relative to path to be served
	Defaultpath *string `json:"defaultpath,omitempty"`

	// Filesize Size of the produced file
	...
	// Subtype user-specified
	Subtype *string `json:"subtype,omitempty"`

	// Type Types of build product (user defined)
	Type *string `json:"type,omitempty"`
}

// DeclarativeInput defines model for DeclarativeInput.
type DeclarativeInput struct {
	// File The file in `value` which contains the declarative spec file. Relative to the root of `value`.
	File *string `json:"file,omitempty"`

	// Type The type of the declarative input.
	Type *string `json:"type,omitempty"`

	// Value The value of the declarative input.
	Value *string `json:"value,omitempty"`
}
...
type Evaluations struct {
	...
	Evals *[]map[string]JobsetEval `json:"evals,omitempty"`

	// First first list of results
	First *string `json:"first,omitempty"`

	// Last last list of results
	Last *string `json:"last,omitempty"`

	// Next next list of results
	Next *string `json:"next,omitempty"`
}

// Jobset defines model for Jobset.
type Jobset struct {
	// Checkinterval interval (in seconds) in which to check for evaluation
	Checkinterval *int `json:"checkinterval,omitempty"`

	// Description a description of the jobset
	Description *string `json:"description"`

	// Emailoverride email address to send notices to instead of the package maintainer (can be a comma separated list)
	Emailoverride *string `json:"emailoverride,omitempty"`

	// EnableDynamicRunCommand when true the jobset supports executing dynamically defined RunCommand hooks. Requires the server and project's configuration to also enable dynamic RunCommand.
	EnableDynamicRunCommand *bool `json:"enable_dynamic_run_command,omitempty"`

	// Enabled 0 is disabled, 1 is enabled, 2 is one-shot, and 3 is one-at-a-time
	Enabled *int `json:"enabled,omitempty"`

	// Enableemail when true the jobset sends emails when previously-successful builds fail
	Enableemail *bool `json:"enableemail,omitempty"`

	// Errormsg contains the stderr output of the nix-instantiate command
	Errormsg *string `json:"errormsg"`

	// Errortime timestamp associated with errormsg
	Errortime *int `json:"errortime"`

	// Fetcherrormsg contains the error message when there was a problem fetching sources for a jobset
	Fetcherrormsg *string `json:"fetcherrormsg"`

	// Flake the flake uri to evaluate
	Flake *string `json:"flake"`

	// Inputs inputs configured for this jobset
	Inputs *map[string]JobsetInput `json:"inputs,omitempty"`

	// Keepnr number or evaluations to keep
	Keepnr *int `json:"keepnr,omitempty"`

	// Lastcheckedtime the last time the evaluator looked at this jobset
	Lastcheckedtime *int `json:"lastcheckedtime"`

	// Name the name of the jobset
	Name *string `json:"name,omitempty"`

	// Nixexprinput the name of the jobset input which contains the nixexprpath
	Nixexprinput *string `json:"nixexprinput"`

	// Nixexprpath the path to the file to evaluate
	Nixexprpath *string `json:"nixexprpath"`

	// Project the project this jobset belongs to
	Project *string `json:"project,omitempty"`

	// Schedulingshares how many shares to be allocated to the jobset
	Schedulingshares *int `json:"schedulingshares,omitempty"`

	// Startime set to the time the latest evaluation started (if one is currently running)
	Startime *int `json:"startime"`

	// Triggertime set to the time we were triggered by a push event
	Triggertime *int `json:"triggertime"`

	// Type the type of the jobset
	Type *int `json:"type,omitempty"`

	// Visible when true the jobset is visible in the web frontend
	Visible *bool `json:"visible,omitempty"`
}

// JobsetEval defines model for JobsetEval.
type JobsetEval struct {
	// Builds List of builds generated for this jobset evaluation.
	Builds *[]int `json:"builds,omitempty"`

	// Checkouttime How long it took (in seconds) to fetch the jobset inputs.
	Checkouttime *int `json:"checkouttime,omitempty"`

	// Evaltime How long it took (in seconds) to evaluate the jobset.
	Evaltime *int `json:"evaltime,omitempty"`

	// Flake For flake jobsets, the immutable flake reference allowing you to reproduce this evaluation. Null otherwise.
	Flake *string `json:"flake"`

	// Hasnewbuilds Whether the number of JobsetEval members is different from the prior evaluation. This is always true on the first evaluation.
	Hasnewbuilds     *bool                       `json:"hasnewbuilds,omitempty"`
	Id               *int                        `json:"id,omitempty"`
	Jobsetevalinputs *map[string]JobsetEvalInput `json:"jobsetevalinputs,omitempty"`

	// Timestamp Time in seconds since the Unix epoch when this evaluation was created.
	Timestamp *int `json:"timestamp,omitempty"`
}

// JobsetEvalBuilds defines model for JobsetEvalBuilds.
type JobsetEvalBuilds = []map[string]Build

// JobsetEvalInput defines model for JobsetEvalInput.
type JobsetEvalInput struct {
	// Dependency **Deprecated**: The build id of another build
	Dependency *string `json:"dependency"`

	// Revision A Git/Mercurial commit hash or a Subversion revision number.
	Revision *string `json:"revision"`

	// Type The type of this input
	Type *string `json:"type,omitempty"`

	// Uri URI of this input (which differs depending on the type of the input)
	Uri *string `json:"uri"`

	// Value A value that corresponds to the type of input
	Value *bool `json:"value"`
}

// JobsetInput defines model for JobsetInput.
type JobsetInput struct {
	// Emailresponsible whether or not to email responsible parties
...
type JobsetOverview = []struct {
	// Checkinterval interval in seconds at which to check the jobset inputs
	Checkinterval *int `json:"checkinterval,omitempty"`

	// Errortime time an error occurred during evaluation (unix time stamp)
	Errortime *int `json:"errortime,omitempty"`

	// Fetcherrormsg contains the error message when there was a problem fetching sources for a jobset
	Fetcherrormsg *interface{} `json:"fetcherrormsg"`

	// Haserrormsg true if the evaluation had errors
	Haserrormsg *bool `json:"haserrormsg,omitempty"`

	// Lastcheckedtime the last time the jobset inputs where checked to see if an evaluation needs to be scheduled (unix time stamp)
	Lastcheckedtime *int `json:"lastcheckedtime,omitempty"`

	// Name name of the jobset
	Name *string `json:"name,omitempty"`

	// Nrfailed number of failed evaluations
	Nrfailed *int `json:"nrfailed,omitempty"`

	// Nrscheduled number of scheduled evaluations
	Nrscheduled *int `json:"nrscheduled,omitempty"`

	// Nrtotal number of evaluations
	...
	// Triggertime time of the last evaluation trigger for this jobset (unix time stamp)
	Triggertime *int `json:"triggertime"`
}
...
type Project struct {
	...
	// Displayname name to be displayed in the web interface
	Displayname *string `json:"displayname,omitempty"`

	// EnableDynamicRunCommand when true the project's jobsets support executing dynamically defined RunCommand hooks. Requires the server and project's configuration to also enable dynamic RunCommand.
	EnableDynamicRunCommand *bool `json:"enable_dynamic_run_command,omitempty"`

	// Enabled when set to true the project gets scheduled for evaluation
	Enabled *bool `json:"enabled,omitempty"`

	// Hidden when set to true the project is not displayed in the web interface
	Hidden *bool `json:"hidden,omitempty"`

	// Homepage homepage of the project
	Homepage *string `json:"homepage,omitempty"`

	// Jobsets list of jobsets belonging to this project
...
type SearchResult struct {
	// Builds builds matching search term
	Builds *[]Build `json:"builds,omitempty"`

	// Buildsdrv derivations matching search term
	Buildsdrv *[]Build `json:"buildsdrv,omitempty"`

	// Jobsets jobsets matching search term
	Jobsets *[]Jobset `json:"jobsets,omitempty"`

	// Projects projects missing search term
...
type PutApiPushParams struct {
	// Jobsets project and jobset formatted as "<project>:<jobset>" to evaluate
	Jobsets *string `form:"jobsets,omitempty" json:"jobsets,omitempty"`
}
...
type PutProjectIdJSONBody struct {
	...
	// Visible when set to true the project is displayed in the web interface
	Visible *bool `json:"visible,omitempty"`
}
...
type PutJobsetProjectIdJobsetIdJSONRequestBody = Jobset
...
type ClientInterface interface {
	...
	// GetEvalEvalId request
	GetEvalEvalId(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetEvalEvalIdBuilds request
	GetEvalEvalIdBuilds(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// PutJobsetProjectIdJobsetIdWithBody request with any body
...
func (c *Client) GetEvalEvalId(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetEvalEvalIdRequest(c.Server, evalId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetEvalEvalIdBuilds(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetEvalEvalIdBuildsRequest(c.Server, evalId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetEvalEvalIdRequest generates requests for GetEvalEvalId
func NewGetEvalEvalIdRequest(server string, evalId int) (*http.Request, error) {
	var err error

	var pathParam0 string

	pathParam0, err = runtime.StyleParamWithLocation("simple", false, "eval-id", runtime.ParamLocationPath, evalId)
	if err != nil {
		return nil, err
	}
...
// NewGetEvalEvalIdBuildsRequest generates requests for GetEvalEvalIdBuilds
func NewGetEvalEvalIdBuildsRequest(server string, evalId int) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/eval/%s/builds", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// GetApiJobsetsWithResponse request
	...
	// GetEvalEvalIdWithResponse request
	GetEvalEvalIdWithResponse(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*GetEvalEvalIdResponse, error)

	// GetEvalEvalIdBuildsWithResponse request
	GetEvalEvalIdBuildsWithResponse(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*GetEvalEvalIdBuildsResponse, error)

	// GetJobProjectIdJobsetIdJobIdShieldWithResponse request
	...
	// DeleteJobsetProjectIdJobsetIdWithResponse request
	...
	// GetJobsetProjectIdJobsetIdWithResponse request
	...
	// PutJobsetProjectIdJobsetIdWithBodyWithResponse request with any body
	...
	// GetJobsetProjectIdJobsetIdEvalsWithResponse request
...
type GetEvalEvalIdResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *JobsetEval
}
...
// Status returns HTTPResponse.Status
func (r GetEvalEvalIdResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetEvalEvalIdResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetEvalEvalIdBuildsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *JobsetEvalBuilds
}

// Status returns HTTPResponse.Status
func (r GetEvalEvalIdBuildsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetEvalEvalIdBuildsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type DeleteJobsetProjectIdJobsetIdResponse struct {
	...
	HTTPResponse *http.Response
	JSON200      *struct {
		// Redirect root of the Hydra instance
...
type PutJobsetProjectIdJobsetIdResponse struct {
	...
	HTTPResponse *http.Response
	JSON200      *struct {
		// Redirect url pointing to the webui for the created jobset
		Redirect *string `json:"redirect,omitempty"`
	}
	JSON201 *struct {
		// Name name of the created jobset
		Name *string `json:"name,omitempty"`
...
type PutProjectIdResponse struct {
	...
	HTTPResponse *http.Response
	JSON200      *struct {
		// Redirect URL of the created project
		Redirect *string `json:"redirect,omitempty"`
	}
	JSON201 *struct {
		// Name name of the project
		...
		// Type type of the created resource ("project")
		Type *string `json:"type,omitempty"`

		// Uri URL of the created project
		Uri *string `json:"uri,omitempty"`
	}
	JSON400 *struct {
		// Error error message
...
// GetEvalEvalIdWithResponse request returning *GetEvalEvalIdResponse
func (c *ClientWithResponses) GetEvalEvalIdWithResponse(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*GetEvalEvalIdResponse, error) {
	rsp, err := c.GetEvalEvalId(ctx, evalId, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetEvalEvalIdResponse(rsp)
}

// GetEvalEvalIdBuildsWithResponse request returning *GetEvalEvalIdBuildsResponse
func (c *ClientWithResponses) GetEvalEvalIdBuildsWithResponse(ctx context.Context, evalId int, reqEditors ...RequestEditorFn) (*GetEvalEvalIdBuildsResponse, error) {
	rsp, err := c.GetEvalEvalIdBuilds(ctx, evalId, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetEvalEvalIdBuildsResponse(rsp)
}
...
// ParseGetEvalEvalIdResponse parses an HTTP response from a GetEvalEvalIdWithResponse call
func ParseGetEvalEvalIdResponse(rsp *http.Response) (*GetEvalEvalIdResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetEvalEvalIdResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetEvalEvalIdBuildsResponse parses an HTTP response from a GetEvalEvalIdBuildsWithResponse call
func ParseGetEvalEvalIdBuildsResponse(rsp *http.Response) (*GetEvalEvalIdBuildsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetEvalEvalIdBuildsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
